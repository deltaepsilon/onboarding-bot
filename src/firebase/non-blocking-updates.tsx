...
export function setDocumentNonBlocking(docRef: DocumentReference, data: any, options: SetOptions) {
  ...
  setDoc(docRef, data, options).catch((error) => console.error(`Set error for ${docRef.path}:`, error)); // Basic error logging
...
export function addDocumentNonBlocking(colRef: CollectionReference, data: any) {
  ...
  const promise = addDoc(colRef, data).catch((error) => console.error(`Add error for ${colRef.path}:`, error)); // Basic error logging
...
export function updateDocumentNonBlocking(docRef: DocumentReference, data: any) {
  ...
  updateDoc(docRef, data).catch((error) => console.error(`Update error for ${docRef.path}:`, error)); // Basic error logging
...
export function deleteDocumentNonBlocking(docRef: DocumentReference) {
  ...
  deleteDoc(docRef).catch((error) => console.error(`Delete error for ${docRef.path}:`, error)); // Basic error logging
